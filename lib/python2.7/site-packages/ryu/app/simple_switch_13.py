...
class SimpleSwitch13(app_manager.RyuApp):
	...
	#cursor.execute("SELECT CallingStationId from raspostauth")
	
	#cursor.execute ("select CallingStationId from radpostauth")
	...
	#connection.close ()
        ...
        #self.logger.info("UDP Payload %s", udp_payload)
	...
	self.logger.info ("DST is  %s", dst)
	    ...
	    self.logger.info ("Out_Port is the same as destination %s", out_port)	
        else:
